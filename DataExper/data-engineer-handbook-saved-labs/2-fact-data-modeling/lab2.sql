-- The name of the table should had been users_cumulated
-- DROP TABLE users_culated;
-- CREATE TABLE users_culated (
-- 	user_id TEXT,
-- 	-- The list of dates in the past where the user was ative
-- 	dates_active DATE[],
...
GROUP BY user_id
ORDER BY BIT_COUNT(CAST('10000000000000000000000000000000' AS BIT(32)) & CAST(CAST(SUM(placeholder_int_value) AS BIGINT) AS BIT(32))) > 0 ASC;